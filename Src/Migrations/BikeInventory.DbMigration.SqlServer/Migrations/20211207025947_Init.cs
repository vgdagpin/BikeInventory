        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tbl_Customer_tbl_User_ID",
                        column: x => x.ID,
                        principalSchema: "dbo",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "ID", "HandlerAssembly", "HandlerClass", "LongDesc", "ShortDesc", "TaskAssembly", "TaskClass" },
                values: new object[,]
                {
                    { (short)1, "BikeInventory.Application, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "BikeInventory.Application.Handlers.Commands.PaymentCmds.PaymentCmdHandler_GCash", "GCash", "GCash", "BikeInventory, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "BikeInventory.Commands.PaymentCmds.PaymentCmd" },
                    { (short)2, "BikeInventory.Application, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "BikeInventory.Application.Handlers.Commands.PaymentCmds.PaymentCmdHandler_Paymaya", "Paymaya", "Paymaya", "BikeInventory, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "BikeInventory.Commands.PaymentCmds.PaymentCmd" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "ID", "ExpiresOn", "FailedLoginCount", "IsTemporaryPassword", "Password", "Salt", "TemporaryPassword", "Username" },
                values: new object[,]
                {
                    { -1, null, 0, true, new byte[] { 197, 40, 2, 90, 195, 172, 59, 213, 107, 18, 99, 83, 234, 145, 48, 189, 29, 176, 237, 67, 47, 52, 136, 9, 49, 71, 105, 191, 181, 159, 172, 16 }, new byte[] { 48, 48, 48, 48, 48, 48, 48, 48, 45, 48, 48, 48, 48, 45, 48, 48, 48, 48, 45, 48, 48, 48, 48, 45, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 49 }, "admin", "admin@bike.com" },
                    { 1, null, 0, true, new byte[] { 90, 222, 117, 211, 129, 107, 119, 212, 114, 215, 46, 244, 111, 193, 91, 50, 203, 40, 111, 221, 232, 118, 35, 171, 190, 224, 194, 94, 137, 102, 121, 47 }, new byte[] { 48, 48, 48, 48, 48, 48, 48, 48, 45, 48, 48, 48, 48, 45, 48, 48, 48, 48, 45, 48, 48, 48, 48, 45, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 50 }, "staff1", "staff1@bike.com" },
                    { 2, null, 0, true, new byte[] { 165, 4, 10, 239, 119, 73, 236, 58, 52, 216, 234, 65, 60, 50, 223, 115, 7, 187, 190, 113, 118, 243, 224, 206, 147, 255, 240, 178, 214, 97, 168, 37 }, new byte[] { 48, 48, 48, 48, 48, 48, 48, 48, 45, 48, 48, 48, 48, 45, 48, 48, 48, 48, 45, 48, 48, 48, 48, 45, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 50 }, "staff2", "staff2@bike.com" }
                });
            ...
            migrationBuilder.InsertData(
                schema: "dbo",
                table: "tbl_BikeRate",
                columns: new[] { "ID", "BikeID", "EffectiveEndDate", "EffectiveStartDate", "RatePerMinute" },
                values: new object[,]
                {
                    { 1, 1, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m },
                    { 2, 2, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m },
                    { 3, 3, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m },
                    { 4, 4, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m },
                    { 5, 5, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m },
                    { 6, 6, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m },
                    { 7, 7, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m },
                    { 8, 8, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m },
                    { 9, 9, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m },
                    { 10, 10, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m },
                    { 11, 11, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m },
                    { 12, 12, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m },
                    { 13, 13, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m },
                    { 14, 14, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m },
                    { 15, 15, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m },
                    { 16, 16, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m },
                    { 17, 17, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m },
                    { 18, 18, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m },
                    { 19, 19, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m },
                    { 20, 20, null, new DateTime(2021, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0.25m }
                });
